...
# MAGIC 
# MAGIC In the code below, compute the `r2` and return it along with `STATUS_OK` (remember we are trying to maximize R2, so we need to return it as a negative value).
